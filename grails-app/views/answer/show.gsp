...
<head>
	...
	<title><g:message code="answer.show" default="Show Answer"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
	<h1><g:message code="answer.show" default="Show Answer"/></h1>
	...
	<g:form>
		...
		<div class="dialog">
			<table>
				...
				<tr class="prop">
					<td valign="top" class="name"><g:message code="answer.id" default="Id"/>:</td>
				...
				<tr class="prop">
					<td valign="top" class="name"><g:message code="answer.answer" default="Answer"/>:</td>
				...
				<tr class="prop">
					<td valign="top" class="name"><g:message code="answer.date" default="Date"/>:</td>

					<td valign="top" class="value"><g:formatDate date="${answerInstance?.date}"/></td>
