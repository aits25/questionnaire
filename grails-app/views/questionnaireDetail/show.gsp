...
<head>
	...
	<title><g:message code="questionnaireDetail.show" default="Show QuestionnaireDetail"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
	<h1><g:message code="questionnaireDetail.show" default="Show QuestionnaireDetail"/></h1>
	...
	<g:form>
		...
		<div class="dialog">
			<table>
				...
				<tr class="prop">
					<td valign="top" class="name"><g:message code="questionnaireDetail.id" default="Id"/>:</td>

					<td valign="top" class="value">${fieldValue(bean: questionnaireDetailInstance, field: "id")}</td>
