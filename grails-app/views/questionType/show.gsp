...
<head>
	...
	<title><g:message code="questionType.show" default="Show QuestionType"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
	<h1><g:message code="questionType.show" default="Show QuestionType"/></h1>
	...
	<g:form>
		...
		<div class="dialog">
			<table>
				...
				<tr class="prop">
					<td valign="top" class="name"><g:message code="questionType.id" default="Id"/>:</td>
				...
				<tr class="prop">
					<td valign="top" class="name"><g:message code="questionType.type" default="Type"/>:</td>

					<td valign="top" class="value">${fieldValue(bean: questionTypeInstance, field: "type")}</td>
