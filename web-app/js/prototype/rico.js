...
Rico.LiveGrid.prototype = {
	...
	fetchBuffer: function(offset) {
		...
		var callparams = [];
		callparams.push(this.tableId + '_request');
		callparams.push('id=' + this.tableId);
		callparams.push('page_size=' + fetchSize);
		callparams.push('offset=' + bufferStartPos);
		if (this.sortCol) {
			callparams.push('sort_col=' + this.sortCol);
			callparams.push('sort_dir=' + this.sortDir);
		}

		for (var i = 0; i < this.additionalparams.length; i++)
			callparams.push(this.additionalparams[i]);
